...
\item $x_i$ is a type constructor variable i.e. $A_i$ reduces to a kind and
  $x_i$ occurs as a strict subterm in some other $A_j$ which is not a
...
It is important to see that the types of implicit type (or type constructor)
...
\item $A_0$ reduces to a kine and $x_0$ does occur as a strict subterm in the
  type some nonpropositional argument of $R_0$ or in the final result type of
  $R_0$.
\end{enumerate}
