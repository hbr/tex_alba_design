...
\item The expected type $E$ is a type variable without substitution:
  ...
  Introduce the placeholders $x, y, \ldots$.

  Substitute $e$ by $v x y \ldots$ where $v$ is the variable.

  Return the new context with an array pointing to the placeholders of the
  explicits arguments in $x, y, \ldots$.
...
\item The expected type $E$ has a signature:
  ...
  \item $R$ and $E$ start with the same number of implicit arguments:
    ...
    Unify the signatures of $R$ and $E$.
  ...
  \item $R$ starts with more implicit arguments than $E$: I.e. $R = \Pi u^U v^V
    ...
    Unify $R'$ and $E$. Introduce placeholders $x, y, \ldots, u, v, \ldots$.

    Substitute $E$ by $v x y \ldots u v \ldots$.
...
\item Find prefix of the formal arguments which correspond to the $n$
  ...
  until $n$ explicit arguments are found.
