...
Input: Number of explicit arguments, Expected types of term applied to
...
syntactic term and all implicit arguments before, between and after the actual
explicit arguments.
...
t \, a_0 \, a_1 \, \ldots : T
$$
and unify it with the expected types.
