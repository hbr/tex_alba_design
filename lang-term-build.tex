...
\item Term in the intermediate language (and maybe its type)
...
The type of a term in function position must have a type which in key normal
form looks like
...
An argument described by the pair $x_i: A_i$ is implicit if it occurs either
in some of the following nonpropositional $A_j$ for $i < j$ or in the
