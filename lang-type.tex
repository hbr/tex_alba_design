...
$$
If we have a polymorphic function living in the universe $i$
$$
    f: \Pi A^{\Any_i}. B
$$
then this function cannot be fed into as an argument to a polymorphic function
of the same universe level. The receiving function must be in a higher level
universe.

Conclusion: Polymorphic functions are not first class in the absence of
cumulative universes. In order to pass a polymorphic function around we have to
provide at least the type arguments.
