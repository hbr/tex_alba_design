...
\begin{description}
\item[Binders] The user can write in program text
  \begin{alba}
    \ x y := e
...
\item[Implicit Type Arguments] Polymorphic functions need type arguments in
  the intermediate language. The user does not provide this
  information. Therefore the source code terms
  \begin{alba}
